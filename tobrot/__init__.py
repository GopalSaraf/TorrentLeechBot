...
AUTH_CHANNEL = [int(x) for x in os.environ.get("AUTH_CHANNEL", "-1001374445001 -1001554287360 -1001320054638").split()]
...
LOG_COMMAND = os.environ.get("LOG_COMMAND", "log@torrgsbot")
